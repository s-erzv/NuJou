...
/**
 * React Bits "CardSwap": a 3D stack of cards that cycles — the front card
 * drops away, the rest promote forward, and it returns to the back of the
 * stack. Ported to TypeScript.
 */
export default function CardSwap({
  ...
  useEffect(() => {
    ...
    // Reduced motion: leave the stack placed but never cycle it.
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement<CardProps>(child)
      ? cloneElement(child, {
        ...
        } as Partial<CardProps> & { ref: RefObject<HTMLDivElement> })
      : child,
  );
