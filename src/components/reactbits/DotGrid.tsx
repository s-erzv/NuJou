...
/**
 * React Bits "DotGrid": a canvas grid of dots that tint near the cursor and get
 * physically shoved around by fast pointer movement or a click shockwave
 * (GSAP InertiaPlugin). Ported to TypeScript.
 */
export default function DotGrid({
  ...
  useEffect(() => {
    // Reduced motion: dots still render and tint, but skip the physics shoves.
